...
CREATE TABLE CHATROOM(
    ...
    SELLER_ID NUMBER(13) NOT NULL, --판매자ID(CLIENT_ID)
    SELLER_NAME VARCHAR2(50) NOT NULL, --판매자이름
    BUYER_ID NUMBER(13) NOT NULL, --구매자ID(CLIENT_ID)
...
CREATE TABLE CHATMESSAGE(
    ...
    CLIENT_ID NUMBER(13) NOT NULL, --클라이언트ID
    CLIENT_NAME VARCHAR2(50) NOT NULL  --클라이언트이름
);
